...
试试这些skills！将高质量期刊级别图表，流程架构图，亦或是交互式图表以及高性能AI的绘图逻辑联合蒸馏成的一份可在**Codex/Claude/Openclaw**进行绘制的技能。
...
**将skills文件夹里你想要的skill添加到** **claude** **里即可使用**
...
### 特色
 ...
 D3.js构建高质量交互式可视化，输出独立可运行的深色主题 HTML 文件，实现高质量、高交互性图的需求
